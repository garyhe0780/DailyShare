...
function ArticleSummary({ article }: { article: Article }) {
  return (
    <a class="flex gap-4 flex-col sm:flex-row" href={`/articles/${article.id}`}>
      <img
        src={article.image_url || 'https://images.unsplash.com/photo-1485846234645-a62644f84728?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2318&q=80'}
